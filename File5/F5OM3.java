...
public class OM3 {
    ...
    private PrintWriter printWriterOut; //Sendreplacetowordsclient
    private BufferedReader bufferedReader; // words comments to
...
// Random line of code
    ...
    private void headRequest(String[] parts, String directory, String request) {
        ...
        try {
            FileReader fileReader = new FileReader(path); // comments words to to to random words replace random to
